...
public class GeneratedPaletteFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        try {
            bmp0 = load("generatedPalette0", getActivity());
            bmp1 = load("generatedPalette1", getActivity());
            bmp2 = load("generatedPalette2", getActivity());
            bmp3 = load("generatedPalette3", getActivity());
            bmp4 = load("generatedPalette4", getActivity());
            bmp5 = load("generatedPalette5", getActivity());
        } catch (Exception e){
            e.printStackTrace();
        }
